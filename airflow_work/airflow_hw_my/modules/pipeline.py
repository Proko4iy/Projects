...
#path = os.path.abspath('/home/airflow/airflow_hw/airflow_hw')
...
def pipeline() -> None:
    df = pd.read_csv(f'/home/airflow/airflow_hw/data/train/homework.csv')
    ...
    best_pipe.fit(X, y)
    model_filename = f'/home/airflow/airflow_hw/data/models/cars_pipe_{datetime.now().strftime("%Y%m%d%H%M")}.pkl'
